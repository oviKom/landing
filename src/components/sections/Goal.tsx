...
const Goal: React.FC = (): ReactElement => {
    return (
        <section id={'goal-section'} className={'mt-[calc(100vh_-_88px)] flex flex-col lg:flex-row py-[72px] default-padding justify-between gap-14'}>
            <div className={'lg:w-[50%] xl:w-auto max-w-[435px] flex flex-col justify-center'}>
